...
VALUES
    ...
    (
        'Chimborazo',
        'Riobamba',
        'En esta provincia se encuentran varias de las cumbres más elevadas del país, como el Carihuairazo, el Altar, Igualata, Sangay, entre otros, que en algunos casos comparte con otras provincias.',
        '223586.00',
        '6487.00',
        '-1.666667',
        '-78.65',
    ...
    (
        'Cotopaxi',
        'Latacunga',
        'La provincia toma el nombre del volcán más grande e importante de su territorio, el volcán Cotopaxi. Cotopaxi se encuentra dividida políticamente en 7 cantones. Según el último ordenamiento territorial, la provincia de Cotopaxi pertenece a la región centro 3',
        '409 205',
        '6569.00',
        '-0.933333',
        '-78.616667',
    ...
    (
        'Esmeraldas',
        'Esmeraldas',
        'Provincia del Ecuador situada en su costa noroccidental, conocida popularmente como la provincia verde. Su capital homónima es uno de los puertos principales del Ecuador y terminal del oleoducto transandino. Posee un aeropuerto para vuelos nacionales e internacionales.',
        '189504.00',
        '15 954',
        '-0.966667',
        '-79.65',
    ...
    (
        'Galápagos',
        'P. Baquerizo Moreno',
        'Es el mayor centro turístico del Ecuador, así como también una de las reservas ecológicas más grandes e importantes del planeta. Con sus 26.640 habitantes, Galápagos es la provincia menos poblada del país, debido principalmente al afán de conservar al máximo la flora y fauna de la región.',
        '5600.00',
        '8010.00',
        '-0.666667',
        '-90.55',
    ...
    (
        'Guayas',
        'Guayaquil',
        'Es el mayor centro comercial e industrial del Ecuador. Con sus 3,8 millones de habitantes, Guayas es la provincia más poblada del país, constituyéndose con el 24,5% de la población de la República.',
        '2526927.00',
        '17139.00',
        '-2.2',
        '-79.9667',
    ...
    (
        'Loja',
        'Loja',
        'Loja es una ciudad del Ecuador, capital de la provincia y cantón Loja, tiene una rica tradición en las artes, y por esta razón es conocida como la capital musical y cultural del Ecuador.',
        '206.83',
        '57.00',
        '-3.833',
        '-80.067',
    ...
    (
        'Morona Santiago',
        'Macas',
        'Morona Santiago (nombre oficial Provincia de Morona Santiago) es una de las 24 provincias que conforman la República del Ecuador. Es una provincia de la Amazonía ecuatoriana. Su capital es la ciudad de Macas, la cual además, es su urbe más poblada. Su territorio limita al norte con Pastaza, al sur con Zamora Chinchipe, al este con Perú, y al oeste con Tungurahua, Azuay, Chimborazo y Cañar. Ocupa una superficie de 25.690 km2, un área similar a la de Cerdeña.',
        '147940.00',
        '25690.00',
        '-2.366667',
        '-78.133333',
    ...
    (
        'Sucumbios',
        'Nueva Loja',
        'Sucumbíos es una provincia del nor-oriente del Ecuador. Su capital es Nueva Loja. Es una de las principales provincias que proveen al Estado ecuatoriano del petróleo que necesita para las exportaciones. Se caracteriza por sus bellos paisajes amazónicos, entre ellos el río Aguarico.',
        '176472.00',
        '18612.00',
        '-0.083333',
        '-76.883333',
    ...
    (
        'Zamora Chimchipe',
        'Zamora',
        'Zamora Chinchipe es una provincia de Ecuador ubicada en el sur-oriente de la Amazonía ecuatoriana, que limita con la provincia de Morona Santiago al norte; con la provincia de Loja al oeste; y con Perú al sur y este. Según el último ordenamiento territorial del Ecuador, Zamora Chinchipe pertenece a la Región Sur comprendida también por las provincias de Loja y El Oro. Tiene una superficie de 10.556 km2, la cual comprende una orografía montañosa única que la distingue del resto de provincias amazónicas.',
        '91376.00',
        '10556.00',
        '-2.883333',
        '-79',
